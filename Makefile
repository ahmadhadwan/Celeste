...
WINMACROS=-DNDEBUG -DCELESTE_GLFW -DCELESTE_GORILLA_AUDIO -DCELESTE_AUDIO_ASYNC
WINCFLAGS=-Ofast -Wall -I$(INC_DIR) -I$(EXT_DIR) $(WINMACROS)
WINLFLAGS=-lglfw3 -lgdi32 -lm -lpthread -lsoft_oal -lfreetype-6
...
clean:
	...
	@rm -f $(CORE_OBJS) $(OBJS_DIR)sandbox.o $(CELESTE_CORE) $(SANDBOX)

winclean:
	@echo "Cleaning $(WINBIN_DIR) directory.."
	@rm -f $(WINCORE_OBJS) $(WINOBJS_DIR)sandbox.o $(WINCELESTE_CORE) $(WINSANDBOX)
