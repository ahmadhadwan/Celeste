...
MACROS=-DNDEBUG -DCELESTE_GLFW -DCELESTE_GORILLA_AUDIO -DCELESTE_PTHREAD
...
WINMACROS=-DNDEBUG -DCELESTE_RELEASE -DCELESTE_GLFW -DCELESTE_GORILLA_AUDIO -DCELESTE_PACK_RESOURCES
